          ...
          <ul key={key} className="mb-4 flex flex-col gap-1">
            ...
            <li>
              <Popover placement="right-start" open={openEnquirySection} handler={handleToggleEnquirySection}>
                ...
                >
                  <ul className="flex flex-col gap-1">
                    {pages.slice(5, 8).map(({ icon, name, path }) => (
                      <li key={name}>
                        <NavLink to={`/${layout}${path}`}>
                          {({ isActive }) => (
                            <Button
            ...
            {pages.slice(8,11).map(({ icon, name, path }) => (
              <li key={name}>
                <NavLink to={`/${layout}${path}`}>
                  {({ isActive }) => (
                    <Button
            ...
            <li>
              <Popover placement="right-start" open={openPlanSection} handler={handleTogglePlanSection}>
                ...
                >
                  <ul className="flex flex-col gap-1">
                    {pages.slice(11, 14).map(({ icon, name, path }) => (
                      <li key={name}>
                        <NavLink to={`/${layout}${path}`}>
                          {({ isActive }) => (
                            <Button
            ...
            {pages.slice(14,18).map(({ icon, name, path }) => (
              <li key={name}>
                <NavLink to={`/${layout}${path}`}>
                  {({ isActive }) => (
                    <Button
...
<li>
            ...
            {pages.slice(20).map(({ icon, name, path }) => (
              <li key={name}>
                <NavLink to={`/${layout}${path}`}>
                  {({ isActive }) => (
                    <Button
