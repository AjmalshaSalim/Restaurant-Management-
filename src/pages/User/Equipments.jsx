...
export default function Equipments() {
  return (
   <div className='min-h-screen bg-black'>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-2 p-2 mt-8" data-aos="fade-up">
        {equipments.map((equipment) => (
          <div   
          className="block rounded-md bg-white dark:bg-neutral-600 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-100 hover:text-red-400">
          <TERipple>
            <div data-aos="fade-up"
          data-aos-delay={`${equipment.id * 50}`} 
              className="relative overflow-hidden bg-cover bg-no-repeat object-cover h-48 ">
              <img
