        ...
        <div className="mt-10 bg-transparent">
          ...
          >
            ...
            {showAddAttendanceForm ?
              ...
              <div className={` ${sidenavType === 'dark' ? "bg-gray-900 border-gray-800 shadow-2xl" : "bg-white border-blue-gray-100 shadow-2xl"} mx-2 border-x border-y rounded-xl w-[96%] md:w-[40%] h-auto md:h-[400px] z-1 absolute left-0 md:left-[30%]`}
                data-aos="fade-up"
                ...
                <div className="flex flex-col">
                  ...
                  <select id="attendance" className={`mx-5 mb-2 rounded-md py-1 px-3 border-x border-y   ${sidenavType === 'dark' ? " bg-gray-900 border-gray-800 text-white" : "bg-white border-blue-gray-200 text-black"}`} onChange={(e) => setAttendanceFormData(e.target.value)}>
                  ...
                  <div className="mx-5 mb-2 mt-2">
                    <div className=' mt-3 flex'>
                      <div className=' w-4/5'>
                        ...
                        <input type="search" placeholder="Search" onChange={(e) => setAttendanceFormData(e.target.value)} className={`border-x border-y w-full  px-3 py-1 rounded-md focus:outline-none focus:border-gray-500 ${sidenavType === 'dark' ? "text-white  bg-gray-900 border-gray-300" : "text-black border-blue-gray-200"}`} />
                      </div>
                      <div className=' w-1/5'>
                        <div className='h-1/2'></div>
                        <button className={` pb-2 -mt-1 px-3 md:px-4 ml-3 rounded pt-1 ${sidenavType === 'dark' ? "bg-red-700 hover:bg-red-900 text-white" : "bg-black hover:bg-gray-900 text-white"}`}>Search</button>
                      </div>
                    </div>
