...
export function SignUp () {
  ...
  return (
    <section className="m-8 flex">
      <div className="w-2/5 h-full hidden lg:block" data-aos="fade-right" data-aos-duration="2000">
        <img src={Logo} alt="" className=" w-[200px] absolute p-2"  data-aos="fade-left" data-aos-duration="2000" />
        <img
          src={BackgroundImage}
      ...
      <div className="w-full lg:w-3/5 flex flex-col items-center justify-center" data-aos="fade-bottom" data-aos-duration="2000">
